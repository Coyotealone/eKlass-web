...
class PositionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoyoteApiBundle:Position')->findAll();
     ...
     * @Method("POST")
     * @Template("CoyoteApiBundle:Position:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoyoteApiBundle:Position')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoyoteApiBundle:Position:edit.html.twig")
     */
